...
(
    ...
    auto_increment,
    CONSTRAINT PK_CUSTOMER_ID_TABLE PRIMARY KEY
    (CUSTOMER_ID)
);
    ...
    (
        ...
        auto_increment,
    CONSTRAINT PK_EMPLOYEE_ID_TABLE PRIMARY KEY
        (EMPLOYEE_ID)
);
        ...
        (
            ...
            auto_increment,
    CONSTRAINT PK_ACCOUNT_ID_TABLE PRIMARY KEY
            (ACCOUNT_ID)
);
            ...
            (
                ...
                auto_increment,
    CONSTRAINT PK_COLLATERAL_ID_TABLE PRIMARY KEY
                (COLLATERAL_ID)
);
                ...
                (
                    ...
                    auto_increment,
    CONSTRAINT PK_LOAN_ID_TABLE PRIMARY KEY
                    (LOAN_ID)
);
                    ...
                    (
                        ...
                        auto_increment,
    CONSTRAINT PK_BRANCH_ID_TABLE PRIMARY KEY
                        (BRANCH_ID)
);
                        ...
                        (
                            ...
                            auto_increment,
    CONSTRAINT PK_TRANSACTION_ID_TABLE PRIMARY KEY
                            (TRANSACTION_ID)
);
...
BEFORE
                            ...
                            BEGIN
                                DECLARE ID_AUTO INT;
                            INSERT INTO COLLATERAL_ID_TABLE
                            VALUES();
                            SET ID_AUTO
                            = last_insert_id
                            ();
...
FOR
                            ...
                            BEGIN
                                DECLARE ID_AUTO INT;
                            INSERT INTO TRANSACTION_ID_TABLE
                            VALUES();
                            SET ID_AUTO
                            = last_insert_id
                            ();
...
DELIMITER ;
                            ...
                            insert into customer
                                (name, birth_date, gender, identity_number, phone, address, email, type, status, register_date)
                            values
                            ...
                            INSERT INTO Currency
                                (currency_code, currency_name, rate_to_usd)
                            VALUES
                            ...
                            -- ----------- account -------------
                            INSERT INTO Account
                                (customer_id, branch_id, account_type, currency, balance, status, open_date, close_date)
                            VALUES
                            ...
                            INSERT INTO Collateral
                                (owner_id, asset_type, estimated_value, currency, status)
                            VALUES
                            ...
                            INSERT INTO Transaction
                                (from_account, to_account, transaction_type, amount, currency, date, status)
                            VALUES
                            ...
                            -- -------- loan ------------
                            INSERT INTO Loan
                                (customer_id, loan_type, amount, currency, interest_rate, start_date, end_date, status, collateral_id)
                            VALUES
                            ...
                            -- -------- user_authen --------------
                            INSERT INTO account_authen
                                (username, password, user_type, account_id, salt)
                            VALUES
                            ...
                            INSERT INTO Employee
                                (full_name, branch_id, role, status, created_at, phone, address, email, username)
                            VALUES
